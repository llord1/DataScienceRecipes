...
libraries <- c('dplyr', 'tidyr', 'ggpubr', 'mnmacros', 'nortest', 'mvnormtest', 'biotools', 'psych')
# if needed
...
Both plots look like we might be normal, or that we can wrangle them into being normal.
...
Given that only one of the numbers is not normal after transformation, it seems reasonable enough to procede. 
