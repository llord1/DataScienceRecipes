...
Lexical diversity was captured using the both a normal type-token ratio as well as a moving average type-token ratio (MATTR) with a window size of 500 and 1000.
